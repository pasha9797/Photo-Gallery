...
import ru.vsu.csf.pchernyshov.photogallery.client.AuthClient;
import ru.vsu.csf.pchernyshov.photogallery.client.MockAuthClient;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private final AuthClient authClient = new MockAuthClient(new Credentials("admin", "password"));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Credentials credentials = SaveSharedPreference.getCredentials(getApplicationContext());
        if (credentials != null) {
        ...
        Button skipButton = findViewById(R.id.skip_login);
        skipButton.setOnClickListener(view -> goToMainActivity(null));
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            return authClient.authenticate(new Credentials(mUsername, mPassword));
        }
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                goToMainActivity(new Credentials(mUsername, mPassword));
            } else {
